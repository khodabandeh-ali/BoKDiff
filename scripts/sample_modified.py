...
if __name__ == '__main__':
    ...
    parser.add_argument('--ori_data_path', type=str, default='./data/train_set')
    parser.add_argument('--index_path', type=str, default='./data/train_index.pkl')
